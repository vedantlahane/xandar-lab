...
export default function ProblemCanvas({
  ...
  return (
    <div className="relative h-full bg-card pt-12">
      {/* Top Fade */}
      <div className="pointer-events-none absolute top-0 left-0 right-0 h-24 bg-linear-to-b from-card to-transparent z-20" />
                    ...
                    {topic.problems.map((problem) => {
                      ...
                      return (
                        <button
                          ...
                          className={`group relative w-full border-b border-border/40 px-4 py-3 text-left transition-all hover:bg-linear-to-l hover:from-transparent hover:to-accent/40 ${

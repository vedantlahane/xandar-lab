...
const CALLOUT_STYLES: Record<CalloutType, { bg: string; border: string; text: string; icon: React.ElementType }> = {
    info:    { bg: 'bg-sky-500/8',     border: 'border-sky-500/30',    text: 'text-sky-600 dark:text-sky-400',    icon: Info },
    warning: { bg: 'bg-amber-500/8',   border: 'border-amber-500/30',  text: 'text-amber-600 dark:text-amber-400', icon: AlertTriangle },
    tip:     { bg: 'bg-violet-500/8',  border: 'border-violet-500/30', text: 'text-violet-600 dark:text-violet-400', icon: Lightbulb },
    danger:  { bg: 'bg-red-500/8',     border: 'border-red-500/30',    text: 'text-red-600 dark:text-red-400',    icon: XCircle },
    success: { bg: 'bg-emerald-500/8', border: 'border-emerald-500/30',text: 'text-emerald-600 dark:text-emerald-400', icon: CheckCircle },
}
        ...
        <NodeViewWrapper>
            <div className={cn('relative my-3 flex gap-3 rounded-lg border p-4 text-sm', style.bg, style.border)}>
                ...
                {showPicker && (
                    <div
                        contentEditable={false}
                        className="absolute left-0 top-full mt-1 z-50 flex gap-1 p-1.5 rounded-lg border border-border/50 bg-background shadow-xl"
                    >
